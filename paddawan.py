...
#for i in range(256):
##!This additional part of the loop can be used to find the increment in padding, or iterate through every possible combination of th two numbers, but it is ultimately unnecessary    
##    for x in range(256):
##        if x == 197:
##            continue
...
#byte28 = ord("o") ^ 52
#byte27 = ord("h") ^ 205
#ciphertext = control[0:27] + chr(byte27) + chr(byte28) + chr(byte29) + chr(byte30) + chr(byte31) + control[32:]
